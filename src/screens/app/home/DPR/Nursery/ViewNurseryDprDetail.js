...
export default function ViewNurseryDprDetail({ route }) {
                    ...
                    userData?.roleName?.includes(ROLES.EPO_INCHARGE) ? null : (
                      <View style={styles.inputContainer}>
                        ...
                        <TextInput
                          ...
                          editable={
                            dprData?.currentDprStatus == "APPROVED" &&
                            userData?.roleName?.includes(
                              ROLES.EPO_NURS_CENT_INCH,
                            )
                          }
                          style={
                            dprData?.currentDprStatus == "APPROVED" &&
        ...
        payload = [
          {
            ...
            dprType: dprData?.dprType || "NURSERY",
            ...
            nurseryId: dprData?.nurseryId || null,
            nurseryName: dprData?.nurseryName || null,
